//     This file has been customised. Portions of the file which have been customised have been wrapped with comments
//     indicating such, e.g. /* <Customisation> */ and /* </Customisation> */
...
(function(){
  ...
  Backbone.sync = function(method, model, options) {
    ...
    params.beforeSend = function (jqXHR, settings) {
      if (paramsBeforeSend) paramsBeforeSend.apply(this, arguments)
    ...
    ajaxDeferred.fail( function(jqXHR, textStatus, errorThrown) {
      model.trigger("sync:fail", method, model, jqXHR, textStatus, errorThrown)
    });
